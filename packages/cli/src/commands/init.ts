...
export async function initCommand(options: InitOptions): Promise<void> {
  ...
  await copyTemplate('src/screens/ExampleScreen.tsx.template', targetDir, 'src/screens/ExampleScreen.tsx');
  await copyTemplate('src/screens/ExampleScreen.module.scss.template', targetDir, 'src/screens/ExampleScreen.module.scss');
